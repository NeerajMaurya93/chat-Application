...
public class Clint  implements ActionListener {
    ...
    Clint(){
        ...
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("icons/2.png"));//for image
        ...
        JLabel name = new JLabel(("Rong No."));
        ...
        f.setSize(400,605);
        f.setLocation(800,40);//given the location of the page where it is open
